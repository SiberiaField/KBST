...
#include "minor_functions/distance.c"
...
static int pivot(pointData* points, int num_of_points, int dimension, int cmp_coord){
...
static int partition (pointData* points, int num_of_points, int dimension, int level){
    ...
    int mediana_idx = pivot(points, num_of_points, dimension, cmp_coord);
